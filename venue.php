    ...
    align-items: center ;
        ...
        <header class="masthead">
            ...
            <div class="container-fluid mt-3 pt-2">
                <h4 class="text-center text-white">List of Our Concert Composers</h4>
                <hr class="divider">
                <div class="row-items">
                <div class="col-lg-12">
                    <div class="row">
                ...
                <div class="card venue-list <?php echo $rtl ?>" data-id="<?php echo $row['id'] ?>">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center justify-content-center text-center h-100">
                            <div class="">
                                <div>
                                    <h3>Composer: <b class="filter-txt"><i style="text-decoration-line: underline;"><?php echo ucwords($row['venue']) ?></i></b></h3>
                                    <h6>Composition: <i><?php echo $row['address'] ?></i></h6>
                                </div>
                                <div>
                                <span class="truncate" style="font-size: inherit;"><small>Description: <i style="text-decoration-line: underline;"><?php echo ucwords($row['description']) ?></i></small></span>
                                    <br>
                                <span class="badge badge-secondary"><i class="fa fa-tag">
                                    
                                </i> ENTRY FREE CONCERT <!--<?php echo number_format($row['rate'],2) ?>-->
                                </span>
                                <br>
                                <br>
