				...
				<div class="col-md-12">
					<form action="" id="filter">
						<div class="row form-group">
							<div class="col-md-4">
					            <label for="" class="control-label">Composer</label>
					...
					<div class="row" id="printable">
						<div id="onPrint">
							<p class="text-center">Performance Details</p>
							<hr>
							<p class="">Composer: <span id="venue"></span></p>
							<p class="">Month of: <span id="month-field"></span></p>
						</div>	
						<table class="table table-bordered">
							<thead>
								<th class="text-center">ConcertNumer</th>
								<th class="text-center">Number of conductors</th>
								<th class="text-center">Number of soloist</th>
								<th class="text-center">Number of composers</th>
								<th class="text-center">Number of compositions performed</th>
							</thead>
							<tbody>
								<tr><th colspan="5"><center>Select composer First.</center></th></tr>
							</tbody>
						</table>
					</div>
				</div>
