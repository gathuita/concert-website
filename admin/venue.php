		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<i class="fa fa-plus"></i> New Composition
				</a></span>
					</div>
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<thead>
								<tr>
									<th class="text-center">Composition_ID</th>
									<th class="">Composer Name</th>
									<th class="">Composition Name</th>
