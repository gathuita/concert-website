		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<i class="fa fa-plus"></i> New Conductor</button>
				</span>
					</div>
					<div class="card-body">
						...
						<table class="table table-bordered table-condensed table-hover">
							<thead>
								<tr>
									<th class="text-center">Conductor ID</th>
									<th class="">Concert Details</th>
									<th class="">Conductor Name</th>
									<th class="">Status</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										 <!--<p>Composer: <b><?php echo ucwords($row['event']) ?></b></p>-->
