				...
				<div class="col-md-12">
					<form action="" id="filter">
						<div class="row form-group">
							<div class="col-md-4">
					            <label for="" class="control-label">Concert Season</label>
					...
					<div class="row" id="printable">
						<div id="onPrint">
							<p class="text-center">Concert List and Details</p>
							<hr>
							<p class="">Concert: <span id="ename"></span></p>
							<p class="">Composer: <span id="evenue"></span></p>
						</div>	
						<table class="table table-bordered">
							<thead>
								<th class="text-center">Concert Number</th>
								<th class="text-center">Concert Season</th>
								<th class="text-center">Conductors</th>
								<th class="text-center">Soloist</th>
								<th class="text-center">composers</th>
								<th class="text-center">Composition Perfomed</th>
								<th class="text-center">Total Number ofPerformers</th>
							</thead>
							<tbody>
								<tr><th colspan="5"><center>Select Season First.</center></th></tr>
							</tbody>
						</table>
					</div>
				</div>
